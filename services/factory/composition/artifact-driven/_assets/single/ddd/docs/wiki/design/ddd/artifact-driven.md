...
| 4 Implementation | Implementation experts | Code the model in `src/<name>/`. Keep the domain rules in the domain code, the use cases in the application code, and the adapters in the infrastructure code. | The code and the tests. |
