...
- Resolve each configured board reference to its internal board ID before label creation (see [spec-resolve-trello-board-id](spec-resolve-trello-board-id.md)).
