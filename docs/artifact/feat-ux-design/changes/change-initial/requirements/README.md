...
| --- | --- | --- | --- | --- |
| Repository factory | Core | context-factory | Factory maintainer, software team, requirement expert, solution expert, designer expert | UX Design enabled, Requirements accepted, Design completed |
...
| [req-design-tool](req-design-tool.md) | The designer expert should use an optional design tool, but must produce the Design artifact without it. | Should |
