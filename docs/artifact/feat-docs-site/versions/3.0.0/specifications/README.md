...
| [spec-deployment-notification](spec-deployment-notification.md) | Configure and send a documentation site deployment message. Superseded in part by spec-multiple-deployment-providers. | req-deployment-notification |
| [spec-multiple-deployment-providers](spec-multiple-deployment-providers.md) | Define provider configuration and delivery for all selected providers. | req-multiple-deployment-providers |
