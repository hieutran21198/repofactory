...
Superseded by [req-multiple-deployment-providers](req-multiple-deployment-providers.md) for the number of destinations: a notification goes to all selected providers, not to one team destination. The content of the notification still applies.
